...
var file_num_proto_rawDesc = []byte{
	...
	0x74, 0x77, 0x6f, 0x22, 0x1b, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x10,
	...
	0x74, 0x77, 0x6f, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x6e, 0x75,
	0x6d, 0x74, 0x77, 0x6f, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x62,
...
var file_num_proto_goTypes = []interface{}{
	(*Message)(nil),  // 0: numtwo.Message
	(*Request)(nil),  // 1: numtwo.Request
	(*Response)(nil), // 2: numtwo.Response
}
var file_num_proto_depIdxs = []int32{
	1, // 0: numtwo.Num.GetNum:input_type -> numtwo.Request
	2, // 1: numtwo.Num.GetNum:output_type -> numtwo.Response
